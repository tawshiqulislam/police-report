...
<table id="myTable-trans" class="table table-bordered table-hover" cellspacing="0" width="100%">
    ...
    <tbody>
		...
		$sn=0;
		$query=mysqli_query($dbcon,"select * from case_table where status='Completed' AND submit_to_court='0'");
		...
		<td class="empty" width="">
			<a data-placement="left" title="Click to view" id="view<?php echo $id;?>" href="transfer_to_court.php<?php echo '?id='.$id; ?>&status=<?php echo $row['status'] ?>" class="btn btn-success">Transfer<i class="icon-pencil icon-large"></i></a>
