              ...
              <div class="col-md-7">
                ...
                <div class="form-group">
                  ...
                  <label for="">Status:</label>
                      ...
                      <option selected="selected" value="<?php echo $row1['status'];?>"><?php echo $row1['status'];?></option>
              ...
              <div class="form-row" >
                ...
                <div class="form-group">
                  ...
                  <label for="">Confirmation:</label>
                      <select class="form-control" name="confirmation" id ="sdcrime">
                      <option selected="selected" value="<?php echo $row1['confirmation'];?>"><?php echo $row1['confirmation'];?></option>
