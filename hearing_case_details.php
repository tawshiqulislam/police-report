...
include('menubar.php');
    ...
    if(isset($_GET['search'])){
        ...
        $sql = "SELECT * FROM `court` WHERE case_id = '$case_id'";
...
<div class="container-fluid">
	...
	<div class="col-md-10">
	<h3>Upcomming Hearing Date: </h3>
	<?php

	if($extra['hearing_info'] == 'Completed'){
		echo "<h3><mark>Case Closed</mark></h3>";
	}
	else{
		echo "<h3><mark>".$extra['next_hearing_date']."</mark></h3>";
	}
			 	...
			 	<div class="panel-body">
			 		<table id="myTable-party" class="table table-bordered table-hover" cellspacing="0" width="100%">
						    ...
						    <tbody>
						    	<?php
						    	$sn=0;
			 		$query=mysqli_query($dbcon,"SELECT * FROM `hearings` where case_id = '$case_id'");
		while($row = mysqli_fetch_array($query)){
			$sn++;
			?>
						    	<tr>
...
?>
						   ...
						   <center>
							   <a href="main1.php" class="btn btn-success">Return Home
